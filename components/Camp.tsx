  ...
  return (
    <section className='border-2 border-green-500 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        ...
        <CampSite backgroundImage='bg-bg-img-1' title='Mountain View Camp' subtitle='Somewhere in the mountains' peopleJoined='30+ Joined'/>
      </div>

      <div className="flexEnd mt-10 px-10 lg:-mt-60 lg:mr-6">
        ...
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className='regular-14 xl:regular-16 mt-5 text-white'>
            ...
            new climbing location, the possibility of getting lost is very
            high. Therefore, we provide a feature that can help climbers
            find their way back to the basecamp safely and easily.
          </p>
