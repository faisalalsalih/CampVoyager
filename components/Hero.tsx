    ...
    <>
      <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row border-2 border-red-500'>
        ...
        <p className='regular-16 mt-6 text-gray-500 xl:max-w-[520px]'>
          ...
          satisfaction of conquering new places and experiencing
          new adventures. Therefore, we provide a comfortable
          and safe place to rest after a day full of activities
          and exploration.
        </p>
        ...
        <div className='my-11 flex flex-wrap gap-5'>
          ...
          <p className='bold-16 lg:bold-20 text-blue-70'>
            198k 
          <span className='regular-16 lg:regular-20 ml-4 underline'>Excellent Reviews</span>
          </p>
        </div>
          ...
          <div className="relative flex z-20 w-[286px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
            ...
            <div className='flexBetween'>
                ...
                <div className="flex flex-col">
                  ...
                  <p className='bold text-white'>173.28 mi</p>
                </div>
